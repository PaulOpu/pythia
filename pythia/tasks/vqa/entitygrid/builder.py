...
from pythia.tasks.vqa.entitygrid.dataset import EntityGridDataset


@registry.register_builder("entitygrid")
class EntityGridDataBuilder(BaseDatasetBuilder):
    def __init__(self):
        super().__init__("entitygrid")
        self.dataset_class = EntityGridDataset
